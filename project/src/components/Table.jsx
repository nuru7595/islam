    ...
    return (
        <section className="myBorder">
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">7 December 2024</td>
                </tr>
                <tr>
                    <td>Esha</td>
                    <td>Alone - 4 + 2 + 3</td>
                ...
                <tr>
                    <td colspan="2">6 December 2024</td>
                </tr>
                <tr>
                    <td>Esha</td>
                    <td>Jamat - 4 + 2 + 3</td>
                ...
                <tr>
                    <td colspan="2">5 December 2024</td>
                </tr>
                <tr>
                    <td>Esha</td>
                    <td>Jamat - 4 + 2 + 3</td>
                ...
                <tr>
                    <td>Tahajjud Salat</td>
                    <td>Alone - 2</td>
                </tr>
            </table>
            <h3 className="title">1 December 2024</h3>
        </section>
    );
}
